...
public class FileController {
	...
	public void fileDownload( HttpServletResponse response, HttpServletRequest request, FileDownload fileDownload) {
	 
	    String path = userService.filedirectory(fileDownload); //full경로
